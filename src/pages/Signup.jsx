            ...
            >
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-text-secondary">
                        Create your account and start roasting
                    </p>
                </div>
                    ...
                    <form onSubmit={handleEmailSignUp} className="space-y-4">
                        ...
                        <div className="flex items-start gap-3">
                            <input
                                ...
                                disabled={loading}
                                className="mt-1 w-4 h-4 rounded border-glass-border bg-bg-primary text-neon-pink focus:ring-2 focus:ring-neon-pink focus:ring-offset-0 disabled:opacity-50"
                            />
                            <label htmlFor="terms" className="text-sm text-text-muted">
                                I agree to the{' '}
                                <Link to="/terms" className="text-neon-pink hover:text-neon-pink/80">
                                    Terms of Service
                                </Link>{' '}
                                and{' '}
                                <Link to="/privacy" className="text-neon-pink hover:text-neon-pink/80">
                                    Privacy Policy
                                </Link>
                            </label>
                        </div>
